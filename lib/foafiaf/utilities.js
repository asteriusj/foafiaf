...
exports.buildNodesEdges = function (objContent, cb) {
    ...
    var objId = jsonld['@id'];
    //console.log('objId', objId);
    manifest.defaultNode = objId;
    var objGraph = jsonld['@graph'];
    
    nodes = utils.buildRawNodes(objGraph);
    //console.log('nodes',nodes)
    edges = utils.buildRawEdges(nodes)
...
exports.buildRawNodes = function (data) {
...
exports.buildRawEdges = function (rawNodes) {
