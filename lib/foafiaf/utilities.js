...
exports.combineJSONLD = function (arrayJSONLD, cb) {
    ...
    function doStuff(callback) {
        ...
        for (var index = 0; index < arrayJSONLD.length; ++index) {
            ...
            //console.log('objGraph', objGraph.length)
                    ...
                    //      break;
                      ...
                      case 'schema:Projects':
                       ...
                       case 'foafiaf:initiative':
                         console.log("case 'foafiaf:initiative'")
                          myNode.id = graphId;
                       ...
                       case 'foafiaf:objective':
                         console.log("case 'foafiaf:objective'")
                          myNode.id = graphId;
                       ...
                       case 'skos:ConceptScheme':
                         console.log("case 'skos:ConceptScheme'")
                          myNode.id = graphId;
                       ...
                       case 'foaf:topic':
                        ...
                        if (showTags) {
                          myNode.id = graphId;
                          myNode.label = myGraph['foaf:topic'] || myGraph['@id'];
                          myNode.title = myGraph['@type'] + ' ' + myGraph['rdfs:label'] ;
                          myNode.group = 'tags';
                          addNode = true;
                        }
                          break;
